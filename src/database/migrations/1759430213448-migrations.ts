...
export class Migrations1759430213448 implements MigrationInterface {
    name = 'Migrations1759430213448'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("userId" uuid NOT NULL DEFAULT uuid_generate_v4(), "login" character varying NOT NULL, "password" character varying NOT NULL, "createdAt" date NOT NULL DEFAULT '"2025-10-02T18:36:54.653Z"', CONSTRAINT "PK_8bf09ba754322ab9c22a215c919" PRIMARY KEY ("userId"))`);
